function Contact() {
    return (
        <section id="contact" className="relative py-28  max-w-screen-xl mx-auto w-full text-indigo-500">
            ...
            <div
                className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-indigo-800 h-32 w-full"/>
            ...
            <div className="relative p-5 lg:px-20 flex flex-col md:flex-row items-center justify-center">
                ...
                <div className="w-full md:w-1/2 p-5 md:px-0 mx-5">
                    <div className="bg-gray-900 border border-indigo-500 w-full lg:w-1/2 h-full p-5 pt-8">
                ...
                <form action="#" className="w-full md:w-1/2 border border-indigo-500 p-6 bg-gray-900">
